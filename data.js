export const nouns = ["dog", "car", "teacher", "computer", "river", "child", "city", "book", "house", "cat", "bird", "friend", "game", "movie", "song"];
export const adjectives = ["happy", "blue", "fast", "loud", "strange", "bright", "dark", "funny", "serious", "lazy", "brave", "calm", "eager", "fierce", "gentle"];
export const adverbs = ["quickly", "silently", "gracefully", "happily", "angrily", "slowly", "eagerly", "sadly", "brightly", "calmly"];
export const places = ["in the park", "at school", "on the mountain", "by the river", "in the city", "at home", "in the library", "on the beach", "in the garden", "at the museum"];
export const tenses = ["present", "past", "future"];
export const verbs = [
